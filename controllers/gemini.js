...
- 贊助時會填寫顯示的贊助者名稱與備註。
- 接著填寫訂單資料，包括收據資訊（可選電子、紙本），以及收件人資訊。
- 支援 Line Pay 與綠界 ECPay（信用卡、WebATM）付款。

【付款完成】
- 完成付款後會寄出贊助成功通知信和收據到會員註冊信箱，紙本收據會隨回饋品寄出。
- 若選擇 WebATM 虛擬帳號付款，會提供繳款期限提醒，付款完成後系統會自動更新訂單狀態並寄信通知。

【申請提案者】
- 在提案按鈕如果不是提案者的身分，可申請成為提案者，提交衛福部許可網址與銀行專戶資料，由平台審核後取得提案資格。
...
- 贊助者
    ...
    - 可查看自己的提問紀錄。
- 提案者
    - 取得資格後可建立募資專案，並查看以及更新進度、修改資訊、發布更新。
    - 可以回覆贊助者的提問。
